...
namespace Incerrance.WebApp.Areas.Admin.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.CountProduct = db.Insurrances.Where(x => x.IsDeleted == false).Count();
            ViewBag.CountProductCategory = db.InsurranceCategories.Where(x => x.IsDeleted == false).Count();
